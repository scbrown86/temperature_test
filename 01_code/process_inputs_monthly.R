...
huss <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.RELHUM.2160101-2204012.Sahul.1900_1989CE.nc", "RELHUM")
...
huss
# plot(huss[[1:6]])
writeCDF(huss, "02_data/02_processed/single/huss.nc",
     varname = "relhum",
...
pr <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.PRECC.2160101-2204012.Sahul.1900_1989CE.nc", "PRECC") +
     rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.PRECL.2160101-2204012.Sahul.1900_1989CE.nc", "PRECL")
time(pr) <- time(huss)
units(pr) <- "kg/m2/s"
...
pr
par(mfrow = c(1, 2))
plot(pr[[1]], fun = function() lines(land, col = "#FFFFFF"), main = "Jan 1989")
plot(app(pr[[1:12]] * 86400 * c(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31), sum), fun = function() lines(land, col = "#FFFFFF"), main = "1989 total")
writeCDF(pr, "02_data/02_processed/single/pr.nc",
...
# create ta_high
ta_high <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.T.2160101-2204012.Sahul.1900_1989CE.nc", "T")
## need TA @ [z=20]
...
writeCDF(ta_high, "02_data/02_processed/single/ta_high.nc", varname = "T", longname = "T (TA_High)", overwrite = TRUE, unit = "K", zname = "time", prec = "float")

# create ta_low
ta_low <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.T.2160101-2204012.Sahul.1900_1989CE.nc", "T")
## need TA @ z=26
...
writeCDF(ta_low, "02_data/02_processed/single/ta_low.nc",
...
# create tasmax
tasmax <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.TSMX.2160101-2204012.Sahul.1900_1989CE.nc", "TSMX")
...
writeCDF(tasmax, "02_data/02_processed/single/tasmax.nc", varname = "tasmax", longname = "Maximum Temperature", overwrite = TRUE, unit = "K", zname = "time", prec = "float")

# create tasmin
tasmin <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.TSMN.2160101-2204012.Sahul.1900_1989CE.nc", "TSMN")
...
writeCDF(tasmin, "02_data/02_processed/single/tasmin.nc", varname = "tasmin", longname = "Minimum Temperature", overwrite = TRUE, unit = "K", zname = "time", prec = "float")
...
# create tas
tas <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.TS.2160101-2204012.Sahul.1900_1989CE.nc", "TS")
time(tas) <- time(huss)
units(tas) <- "K"
...
tasmax[[1:6]] - tas[[1:6]]
tasmin[[1:6]] - tas[[1:6]]
writeCDF(tas, "02_data/02_processed/single/tas.nc", varname = "tas", longname = "Mean Temperature", overwrite = TRUE, unit = "K", zname = "time", prec = "float")

# create uwind
uwind <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.U.2160101-2204012.Sahul.1900_1989CE.nc", "U")
...
crs(uwind) <- "EPSG:4326"
uwind
writeCDF(uwind, "02_data/02_processed/single/uwind.nc", varname = "U", longname = "Zonal wind", overwrite = TRUE, unit = "m/s", zname = "time", prec = "float")

# create vwind
vwind <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.V.2160101-2204012.Sahul.1900_1989CE.nc", "V")
...
crs(vwind) <- "EPSG:4326"
vwind
writeCDF(vwind, "02_data/02_processed/single/vwind.nc", varname = "V", longname = "Meridional wind", overwrite = TRUE, unit = "m/s", zname = "time", prec = "float")

# create zg_high
zg_high <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.Z3.2160101-2204012.Sahul.1900_1989CE.nc", "Z3")
## need zg @ [z=20]
...
zg_high
writeCDF(zg_high, "02_data/02_processed/single/zg_high.nc", varname = "z3", longname = "Geopotential Height", overwrite = TRUE, unit = "m", zname = "time", prec = "float")

# create zg_low
zg_low <- rast("02_data/01_inputs/single/trace.36.400BP-1990CE.cam2.h0.Z3.2160101-2204012.Sahul.1900_1989CE.nc", "Z3")
## need zg @z=26
...
writeCDF(zg_low, "02_data/02_processed/single/zg_low.nc", varname = "z3", longname = "Geopotential Height", overwrite = TRUE, unit = "m", zname = "time", prec = "float")

# quick lapse rate
# l = tl-th/zh-zl
(lapse <- (ta_low[[1:6]] - ta_high[[1:6]]) / (zg_high[[1:6]] - zg_low[[1:6]]))
plot(lapse, fun = function() lines(land), range = c(0, 0.008))

# Create oro
oro <- project(rast("02_data/01_inputs/single/TraCE21_elevation.nc") * 1, lapse, method = "average")
oro

plot(oro, col = topo.colors(100), fun = function() lines(land, col = "#000000", lwd = 1.5))

time(oro) <- as.Date("1989-06-16")
units(oro) <- "m"
varnames(oro) <- "Orographic elevation"
names(oro) <- format(time(oro), "%b%Y")
crs(oro) <- "EPSG:4326"
oro
writeCDF(oro, "02_data/02_processed/single/oro.nc", varname = "elevation", longname = "Orographic elevation", overwrite = TRUE, unit = "m", zname = "time", prec = "float")
...
tmp_rst <- rast(
     res = 0.04, extent = ext(105, 160, -50, 7),
     crs = "EPSG:4326"
)
tmp_rst
...
writeCDF(oro_4,
     "02_data/02_processed/single/oro_high.nc",
